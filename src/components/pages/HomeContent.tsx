...
const HomeContent: React.FC<HomeContentProps> = ({ testimonials = [] }) => {
    ...
    <div className="flex flex-col animate-fade-in -mt-28">
            ...
            <div className="max-w-2xl animate-slide-up">
              ...
              <div className="mt-12 flex items-center gap-8">
                <div className="flex -space-x-4 space-x-reverse">
                  {[1,2,3,4].map(i => (
                    <div key={i} className="relative w-12 h-12 rounded-full border-2 border-slate-900 overflow-hidden">
                      <Image 
                  ...
                  <div className="w-12 h-12 rounded-full border-2 border-slate-900 bg-teal-600 text-white flex items-center justify-center font-bold text-xs relative">
                    +500
                  </div>
                </div>
                <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              ...
              <Link key={i} href="/procedures" className="group p-8 bg-slate-50 rounded-3xl hover:bg-teal-500 transition duration-300 hover:shadow-xl cursor-pointer border border-slate-100 hover:border-teal-400">
          ...
          <div className="mt-12 text-center">
            <Link href="/procedures" className="inline-flex items-center gap-2 text-teal-600 font-bold hover:text-teal-700 transition border-b-2 border-teal-600 pb-1">
              ...
              {displayTestimonials.map((testimonial) => (
                <div key={testimonial.id} className="bg-slate-50 p-8 rounded-[2rem] hover:bg-white hover:shadow-xl transition-all duration-300 border border-transparent hover:border-slate-100 group">
                  ...
                  <div className="flex items-center gap-4 border-t border-slate-200/50 pt-6">
                    <div className="w-12 h-12 bg-gradient-to-br from-teal-500 to-emerald-600 rounded-full flex items-center justify-center text-white font-bold text-lg shadow-md relative">
      ...
      <section className="py-24 bg-slate-900 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10 flex flex-col md:flex-row items-center gap-16">
          <div className="md:w-1/2 relative aspect-video w-full">
            <Image 
          ...
          <div className="md:w-1/2 text-right">
            ...
            <Link 
              href="/ai-diagnosis"
              className="bg-white text-slate-900 px-8 py-4 rounded-full font-bold hover:bg-purple-50 transition shadow-xl shadow-purple-900/20 inline-flex items-center gap-2"
            >
